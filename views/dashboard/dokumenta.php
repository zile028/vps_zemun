...
<div class="row">
    ...
    <div class="col-md-6 col-lg-2 col-xlg-3">
        <a href="/dashboard/dokumenta/akreditacija">
            <div class="card card-hover">
                <div class="box bg-cyan text-center">
                    <h1 class="font-light text-white">
                        <i class="mdi mdi-view-dashboard"></i>
                    </h1>
                    <h6 class="text-white">АКРЕДИТАЦИЈА</h6>
                </div>
            </div>
        </a>
    </div>
    ...
    <!-- Column -->
    <div class="col-md-6 col-lg-2 col-xlg-3">
        <a href="/dashboard/dokumenta/pravilnici">
            <div class="card card-hover">
                <div class="box bg-cyan text-center">
                    <h1 class="font-light text-white">
                        <i class="mdi mdi-view-dashboard"></i>
                    </h1>
                    <h6 class="text-white">ПРАВИЛНИЦИ</h6>
                </div>
            </div>
        </a>
    </div>
    ...
    <!-- Column -->
    <div class="col-md-6 col-lg-2 col-xlg-3">
        <a href="/dashboard/dokumenta/akta">
            <div class="card card-hover">
                <div class="box bg-cyan text-center">
                    <h1 class="font-light text-white">
                        <i class="mdi mdi-view-dashboard"></i>
                    </h1>
                    <h6 class="text-white">АКТА</h6>
                </div>
            </div>
        </a>
    </div>
    ...
    <!-- Column -->
    <div class="col-md-6 col-lg-2 col-xlg-3">
        <a href="/dashboard/dokumenta/samovrednovanje">
            <div class="card card-hover">
                <div class="box bg-cyan text-center">
                    <h1 class="font-light text-white">
                        <i class="mdi mdi-view-dashboard"></i>
                    </h1>
                    <h6 class="text-white">САМОВРЕДНОВАЊЕ</h6>
                </div>
            </div>
        </a>
    </div>
    ...
    <!-- Column -->
    <div class="col-md-6 col-lg-2 col-xlg-3">
        <a href="/dashboard/dokumenta/informator_rada">
            <div class="card card-hover">
                <div class="box bg-cyan text-center">
                    <h1 class="font-light text-white">
                        <i class="mdi mdi-view-dashboard"></i>
                    </h1>
                    <h6 class="text-white">ИНФРМАТОР РАДА</h6>
                </div>
            </div>
        </a>
    </div>
